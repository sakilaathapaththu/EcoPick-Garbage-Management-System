...
function FetchDriver() {
  ...
  const generateReport = () => {
    ...
    const report = `
      Driver's Image: ${driver.imagePath ? `${API_BASE_URL}/${driver.imagePath}` : 'No image available'}
      Name: ${driver.firstName} ${driver.lastName}
      Address: ${driver.address}
      Contact Number: ${driver.phone}
      NIC: ${driver.nic}
      License Class: ${driver.lclass}
      License Number: ${driver.lnumber}
      Expiry Date: ${driver.expiry}
    `;
